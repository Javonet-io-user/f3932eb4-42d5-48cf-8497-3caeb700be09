...
import RDPCrystalEDILibrary.Rules.*;public class EDIValidator extends Component {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public EDISource getEDISource (){ try { return EDISource.valueOf(((NEnum) javonetHandle.<NEnum>get("EDISource")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
