...
import jio.System.*;public class EDILightWeightDocument extends Component {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public DocumentCreator getCreator (){ try { return DocumentCreator.valueOf(((NEnum) javonetHandle.<NEnum>get("Creator")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
