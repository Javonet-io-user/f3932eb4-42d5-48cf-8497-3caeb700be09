...
import jio.System.*;public class DataElement extends LightWeightElement {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public ElementDataType getDataType (){ try { return ElementDataType.valueOf(((NEnum) javonetHandle.<NEnum>get("DataType")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
