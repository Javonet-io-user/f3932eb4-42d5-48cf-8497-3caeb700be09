...
import RDPCrystalEDILibrary.*;public class EDIError {protected NObject javonetHandle; /**
	 * GetProperty
	 */
            public SnipTestLevel getSnipLevel (){ try { return SnipTestLevel.valueOf(((NEnum) javonetHandle.<NEnum>get("SnipLevel")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
	 ...
	 * GetProperty
	 */
            public EDIValidationMessage getMessage (){ try { return EDIValidationMessage.valueOf(((NEnum) javonetHandle.<NEnum>get("Message")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * GetProperty
	 */
