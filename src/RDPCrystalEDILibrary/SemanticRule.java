...
import jio.System.Collections.Generic.*;public class SemanticRule {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public RuleOperator getRuleOperator (){ try { return RuleOperator.valueOf(((NEnum) javonetHandle.<NEnum>get("RuleOperator")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
	 ...
	 * GetProperty
	 */
            public Usage getUsage (){ try { return Usage.valueOf(((NEnum) javonetHandle.<NEnum>get("Usage")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
