...
import jio.System.Collections.Generic.*;public class Condition extends Node {protected NObject javonetHandle; /**
	 ...
	 * GetProperty
	 */
            public RuleOperator getOperator (){ try { return RuleOperator.valueOf(((NEnum) javonetHandle.<NEnum>get("Operator")).getValueName());} catch (JavonetException _javonetException) { _javonetException.printStackTrace(); return null;} }/**
	 * SetProperty
	 */
