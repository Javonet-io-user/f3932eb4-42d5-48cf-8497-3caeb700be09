...
import jio.System.ComponentModel.*;public abstract class PropertyDescriptor extends MemberDescriptor {public NObject javonetHandle; public PropertyDescriptor(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
