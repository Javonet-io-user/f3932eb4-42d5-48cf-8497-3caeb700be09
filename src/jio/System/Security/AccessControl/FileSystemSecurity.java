...
import jio.System.Security.AccessControl.*;public abstract class FileSystemSecurity extends NativeObjectSecurity {public NObject javonetHandle; public FileSystemSecurity(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
