...
import jio.System.Security.AccessControl.*;public abstract class ObjectSecurity {public NObject javonetHandle; public ObjectSecurity(NObject handle) {this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
