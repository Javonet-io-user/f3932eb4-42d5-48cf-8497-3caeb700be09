...
import jio.System.Security.AccessControl.*;public abstract class CommonObjectSecurity extends ObjectSecurity {public NObject javonetHandle; public CommonObjectSecurity(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
