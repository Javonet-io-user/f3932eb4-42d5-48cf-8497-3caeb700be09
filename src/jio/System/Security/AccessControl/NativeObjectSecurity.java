...
import jio.System.Security.AccessControl.*;public abstract class NativeObjectSecurity extends CommonObjectSecurity {public NObject javonetHandle; public NativeObjectSecurity(NObject handle) {super(handle);this.javonetHandle=handle;}public void setJavonetHandle(NObject handle) {
